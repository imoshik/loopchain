...
class BlockChain:
    ...
    def __add_block(self, block: Block, block_info):
        with self.__add_block_lock:
            ...
            try:
                new_batch, old_batch = self.__batch_block(block, block_info, invoke_results)
    ...
    def __batch_block(self, block: Block, block_info, tx_results):
        new_batch = {}
        old_batch = {}

        new_block_data_batch, old_block_data_batch = self.__batch_block_data(block, block_info)
    ...
    def __batch_block_data(self, block: Block, block_info):
        ...
        if block_info:
            new_batch[BlockChain.BLOCK_INFO_KEY + new_block_hash_encoded] = b'0x1'
